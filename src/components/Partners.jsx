    ...
    return (
        <>
            <div className="sponsors" id="partners">
                ...
                <div className='partners_cta sponsors_description'>
                    <h3>OUR TEAM</h3>
                    <p>College Behind Bars was launched by Sampson, Marisa, Jacob Mensa, Engr Abha  and Emily in September 2021 Since then, we have been joined by a dozen affiliates who instruct and coach students.</p>
                </div>
            </div>
        </>
    )
